...
Files: macbook-16.glb [639.28KB] > /home/thilakshan/Documents/Projects/macbooksite_darazver/macbooksite_darazver/public/models/macbook-16-transformed.glb [629.72KB] (1%)
...
export default function MacbookModel16(props) {
  ...
  useEffect(() => {
    // Update material colors based on the selected color from the store
    scene.traverse((child) => {
      if (child.isMesh) {
        //Change color only if part name is not nochangeparts
        // Nochange parts include objects which represent the screen, keyboard keys, logos, and other details
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.Object_123.geometry} material={materials.sfCQkHOWyrsLmor} rotation={[Math.PI / 2, 0, 0]}>
        <meshBasicMaterial map={texture} /> {/* Screen texture */ } 
      </mesh>
